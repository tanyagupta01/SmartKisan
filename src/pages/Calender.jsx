...
//       <Navbar />
//       {/* Header - matching CropAnalysis style */}
...
//           {/* Input Form Section */}
//           <DashboardCard 
//             title="Generate AI Farming Calendar"
//             className="mb-8"
//           >
...
//           {/* Generation Progress */}
//           {isGenerating && (
//             <DashboardCard title="Generating Your AI Calendar" className="mb-8">
//               <div className="text-center">
//                 <div className="w-16 h-16 mx-auto mb-4">
//                   <div className="w-full h-full border-4 border-green-200 border-t-green-600 rounded-full animate-spin"></div>
//                 </div>
//                 <h3 className="text-xl font-semibold mb-2">AI is Creating Your Calendar</h3>
//                 <p className="text-gray-600 mb-4">Gemini AI is analyzing your crop and location to create a tailored farming schedule...</p>
...
//                   {progress < 30 && "🌱 Analyzing crop requirements..."}
//                   {progress >= 30 && progress < 60 && "🌍 Processing climate data..."}
//                   {progress >= 60 && progress < 90 && "📊 Generating schedule..."}
//                   {progress >= 90 && "✅ Finalizing your calendar..."}
//                 </p>
//               </div>
//             </DashboardCard>
//           )}
...
//               {/* Header Info */}
//               <DashboardCard 
//                 title="Your AI-Generated Farming Calendar"
...
//                       <p className="font-semibold">{calendarData.crop}</p>
//                     </div>
//                   </div>
//                   <div className="flex items-center space-x-2">
...
//                       <p className="font-semibold">{calendarData.location}</p>
//                     </div>
//                   </div>
//                   <div className="flex items-center space-x-2">
...
//                       <p className="font-semibold">{calendarData.season}</p>
//                     </div>
//                   </div>
//                   <div className="flex items-center space-x-2">
...
//                       <p className="font-semibold">{calendarData.weather?.temperature || 'N/A'}</p>
//                     </div>
//                   </div>
//                 </div>
//               </DashboardCard>
...
//                             <h4 className="font-semibold text-gray-900 mb-1">{task.activity}</h4>
...
// Hook for managing translations (same as CropAnalysis)
...
// Translatable Text Component (same as CropAnalysis)
...
const Calender = () => {
  ...
  // Force re-translation when calendar data changes
  useEffect(() => {
    if (calendarData) {
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <TranslatableText 
                  translationKey="calendar_subtitle"
                  tag="p"
                  className="text-sm text-gray-600"
                >
                  Gemini AI-Generated Farming Schedule
                </TranslatableText>
              </div>
            </div>
            <div className="flex items-center space-x-2">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <div translate="no">
                  <Button 
                    ...
                    className="bg-green-600 hover:bg-green-700"
                  >
                    <TranslatableText translationKey="back_to_dashboard_button">
                      Back to Dashboard
                    </TranslatableText>
                  </Button>
                </div>
